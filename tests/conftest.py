...
from app.models import (db, User, Workspace, WorkspaceMember, Channel,
                        ChannelMember, Conversation, Message,
                        UserConversationStatus, Mention)
...
def test_db(app):
    ...
    with app.app_context():
        ...
        tables = [
            User, Workspace, WorkspaceMember, Conversation, Channel,
            ChannelMember, Message, UserConversationStatus, Mention
        ]
