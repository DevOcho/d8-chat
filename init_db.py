from app.models import db, User, Workspace, WorkspaceMember, Channel, ChannelMember, Message, Conversation, initialize_db
from config import Config
from playhouse.db_url import connect
from urllib.parse import urlparse # Import the urlparse function

ALL_MODELS = [User, Workspace, WorkspaceMember, Channel, ChannelMember, Message, Conversation]
